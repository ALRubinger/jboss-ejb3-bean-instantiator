...
public class MockJavaEEComponentInformer implements JavaEEComponentInformer
{
   ...
   {
      throw new RuntimeException("NYI: org.jboss.ejb3.instantiator.deployer.MockJavaEEComponentInformer.getComponentName");
   }

   public boolean isJavaEEComponent(DeploymentUnit unit)
   {
      throw new RuntimeException("NYI: org.jboss.ejb3.instantiator.deployer.MockJavaEEComponentInformer.isJavaEEComponent");
   }
   ...
   {
      throw new RuntimeException("NYI: org.jboss.ejb3.instantiator.deployer.MockJavaEEComponentInformer.getModuleType");
   }
